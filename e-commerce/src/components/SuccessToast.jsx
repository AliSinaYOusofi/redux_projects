...
export default function SuccessToast({messageType, message}) {
    
    const [show, setShow] = React.useState(true);

    
    return show ? (
        <div className=" bg-white border rounded-md shadow-lg w-fit absolute top-20 left-[50%]">
            <div className="flex p-4">
                ...
                <div className="ml-auto pl-3 cursor-pointer" onClick={() => setShow(prev => !prev)}>
