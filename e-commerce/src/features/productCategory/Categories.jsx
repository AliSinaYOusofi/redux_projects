...
export default function Categories() {
    ...
    else if (!categories.length) return <h1 className="text-center mt-20 mx-auto text-4xl font-semibold mb-10 text-white bg-green-600 p-2  rounded-md shadow-md shadow-gray-500/50  w-fit">No Products Found With this category</h1>
