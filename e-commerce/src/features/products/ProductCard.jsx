    ...
    return (
        <div className="w-full hover:shadow-xl transition-all duration-300 ease-in-out max-w-sm bg-white border border-gray-200 rounded-md text-black shadow-sm ">
            ...
            <div className="px-5 pb-5">
                <h1 className="mt-2 text-xl line-clamp-2 font-semibold tracking-tight text-gray-900"> {title}</h1>
                <Link href="#" className="">
                    <h5 className="mt-2.5 mb-5 text-xl line-clamp-2 font-semibold tracking-tight text-gray-900">{description}</h5>
                </Link>
                ...
                <div className="w-full mt-2 flex items-center justify-between">
                    ...
                    <span className="bg-[#F9FAFB] text-sm hover:bg-gray-300 transition-all duration-300 font-light p-1 rounded-md" >
                        #{brand}
                    </span>
                </div>
            </div>
